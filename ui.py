...
with tab1:
    ...
    st.markdown("Upload your datasets to get started with solar power forecasting or You can use the following suitable dataset for testing: [📥 Download the test dataset](https://drive.google.com/file/d/1ckynIL-gCXDGuZ-yBtb6rgr3wYHamzb2/view?usp=sharing)")
